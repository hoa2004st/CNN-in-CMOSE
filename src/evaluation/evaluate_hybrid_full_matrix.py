...
Usage:
    python src/evaluation/evaluate_hybrid_full_matrix.py
    python src/evaluation/evaluate_hybrid_full_matrix.py --train_groups cmose daisee
    python src/evaluation/evaluate_hybrid_full_matrix.py --model_types openface_temporal_i3d_hybrid
"""
