...
Usage:
    python src/evaluation/evaluate_hybrid_model.py
    python src/evaluation/evaluate_hybrid_model.py --arch_key T_TCN_TCN_TCN_TCN
    python src/evaluation/evaluate_hybrid_model.py --append   # append to existing CSV (default)
"""
