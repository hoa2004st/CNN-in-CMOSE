\begin{table}[ht]
\centering
\caption{T12. Per-group marginal effect of encoder choice on mean QWK, in-domain (CMOSE) and pooled over the unseen-target cells.}
\label{tab:T12_group_marginal_combined}
\fittable{%
